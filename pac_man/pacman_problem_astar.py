...
from pac_man.utils import manhattan_distance, euclidean_distance
...
class PacManProblem(Problem):
    ...
    def __init__(self, initial, goal, maze_map, heuristic=None, max_coins=False, shuffle_actions_list=False):
